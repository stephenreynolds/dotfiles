local theme_name = "kamicha"

local function get_theme_path(name)
    local filesystem = require("gears.filesystem")
    local themes_path = filesystem.get_configuration_dir() .. "/themes/"
...
-- {{{ Main
local theme = {}
theme.wallpaper = home_path .. "/Pictures/Wallpapers/mikael-gustafsson-wallpaper-mikael-gustafsson.png"
-- }}}
