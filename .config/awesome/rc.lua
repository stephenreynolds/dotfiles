...
local mytextclock = wibox.widget.textclock(beautiful.widget_markup:format(beautiful.bg_normal, "%a %b %d %l:%M %p"), 60)
...
local keybindings = {
  ...
  {{}, "XF86AudioPlay", volume.play_pause },
  {{}, "XF86AudioPrev", volume.prev },
  {{}, "XF86AudioNext", volume.next },
...
awful.rules.rules = {
  ...
  -- some applications like password prompt for keepassxc autotype should be iating and centered
